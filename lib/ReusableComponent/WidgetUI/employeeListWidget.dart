    ...
    children: [
      Container(
        ...
        child: TextButton(
          ...
          child:Container(
            width: screenWidth,
            padding: EdgeInsets.all(ValueConfig().getHorizontalValueUsingWidth(screenWidth: screenWidth, getWidth: screenWidth>screenHeight?20:SizeConfig().employeeSectionHorizontalPadding)>20?20: ValueConfig().getHorizontalValueUsingWidth(screenWidth: screenWidth, getWidth: SizeConfig().employeeSectionHorizontalPadding)),
            child: Column(
              mainAxisAlignment: MainAxisAlignment.start,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                textWidget(getText: getEmployeeDetail.employeeName, screenHeight: screenHeight, textSize: SizeConfig().employeeListviewEmployeeNameTextSize+(screenWidth<screenHeight?0:SizeConfig().employeeListviewEmployeeNameTextSize*0.25), textColor: ColorConfig().employeeListviewNameTextColor, getAlign: TextAlign.start, textStyle: AppConfig().robotoFontMedium, softWrap: true),
                ...
                textWidget(getText: getEmployeeDetail.employeeRole, screenHeight: screenHeight, textSize: SizeConfig().employeeListviewEmployeeRoleTextSize+(screenWidth<screenHeight?0:SizeConfig().employeeListviewEmployeeRoleTextSize*0.25), textColor: ColorConfig().employeeListviewRoleTextColor, getAlign: TextAlign.start, textStyle: AppConfig().robotoFontRegular, softWrap: true),
                SizedBox(height: ValueConfig().getVerticalValueUsingHeight(screenHeight: screenHeight, getHeight: SizeConfig().employeeListviewBetweenPaddingHeight),),
                textWidget(getText: (getEmployeeDetail.employeeEndDate!=null)?("${ValueConfig().checkTodayDate(getEmployeeDetail.employeeJoinedDate!)?TextConfig().todayText:ValueConfig().getConvertDateFormat(getEmployeeDetail.employeeJoinedDate!)} - ${ValueConfig().checkTodayDate(getEmployeeDetail.employeeEndDate!)?TextConfig().todayText:ValueConfig().getConvertDateFormat(getEmployeeDetail.employeeEndDate!)}"):("${TextConfig().employeeListviewFromText}${ValueConfig().checkTodayDate(getEmployeeDetail.employeeJoinedDate)?TextConfig().todayText:ValueConfig().getConvertDateFormat(getEmployeeDetail.employeeJoinedDate)}"), screenHeight: screenHeight, textSize: SizeConfig().employeeListviewEmployeeDateTextSize+(screenWidth<screenHeight?0:SizeConfig().employeeListviewEmployeeDateTextSize*0.25), textColor: ColorConfig().employeeListviewDateTextColor, getAlign: TextAlign.start, textStyle: AppConfig().robotoFontRegular, softWrap: true),
              ],
            ),
          ),
        ),
